...
Playable exe can be found in the export folder.

The game is based on the Scoundrel card game designed by Zach Gage and Kurt Bieg

Tags: Single Player, Roguelike, Dungeon Crawler, Card Game

CONTROLS (Remappable later):

F2 - New Game
W - Play topmost card
A - Play leftmost card
S - Play bottommost card
D - Play rightmost card
Shift - Toggle to use weapon against enemies
Space - Advance / Avoid room

HOW TO PLAY:

The following rules are copied from the orihinal Scoundrel card game document. Any exceptions in Lurjus are marked with *asterisks*. 

The setup paragraph is not required to study to play the game. However, the logic of Lurjus is coded according to this part, so it might me interesting to learn.
...
Shuffle the remaining cards and place the pile face down on your left. This deck is called the Dungeon. Take out a piece of paper and pen (or use your memory). Mark down 20 on the piece of paper, this is your starting Health. 
*The HP counter in Lurjus is at the top-left corner above your character.*


Rules (Read these to understand the game!):
...
weapons in Scoundrel are binding, meaning if you pick one up, you must equip it, and discard your previous weapon.
...
*The cards are discarded face up in Lurjus. The discard pile is located under your character.*

The Game ends when either your life reaches 0 or you make your way through the entire Dungeon.


Scoring (not important, *read round results part after this*):
...
*Round results in Lurjus:*
There are 4 possible endings for a single game of Lurjus:
- DEFEAT: Your HP is reduced to 0 or below while there are still cards in the draw pile. This causes a game over screen in the full game.
- FINALE: Your HP is reduced to 0 or below but there are no cards in the draw pile. In the full game, This would let you carry on your run with a small penalty.
- VICTORY: There are no cards in the draw pile or the room. You have more than 0 HP but you're not at full health. This would reward you well in the full game.
- FULL VICTORY: There are no cards in the draw pile or the room. You managed to finish the round with full health. This would reward you very handsomely in the full game.
...
placement of the Monster so that the Weapon's number is still showing. subtract the Weapon's value from the Monster's value and subtract any remaining value from your health.

For example, if your Weapon is a 5, and you place a 3 Monster on it, you take no damage.
(3-5 <= 0)

If your Weapon is a 5 and you place a Jack Monster on it, you take 6 damage.
(11 - 5 = 6 dmg)
...
value than the previous Monster it had slain.
*Top monster in the current weapon pile is the weapon's current durability.*
...
you must fight the Queen barehanded as Queen,12, is greater than 6. Despite this, the Weapon is not discarded, as it could still be used against Monsters weaker than a 6.
*Attempting to fight a tougher enemy while having the use of weapon toggled on discards the current weapon and fights the enemy barehanded.*
